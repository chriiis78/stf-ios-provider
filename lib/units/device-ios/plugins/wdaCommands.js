...
.define(function(options, vncControl){
    ...
    plugin.openUrlInSafari = async function(url) {
        var safariSessionId = await plugin.launchAppReturnSession("com.pf.PandaFarmCompanion")
    ...
    plugin.openSettingsWifi = async function() {
        var settingsSessionId = await plugin.launchAppReturnSession("com.pf.PandaFarmCompanion")
